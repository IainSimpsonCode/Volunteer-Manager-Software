...
TextStyle alt_paragraph = GoogleFonts.poppins(
  textStyle: const TextStyle(
...
TextStyle alt_h1 = GoogleFonts.poppins(
  textStyle: const TextStyle(
    color: secondaryColor,
    fontSize: 28,
    fontWeight: FontWeight.w800,
...
TextStyle alt_h2 = GoogleFonts.poppins(
  textStyle: const TextStyle(
    color: secondaryColor,
    fontSize: 22,
    fontWeight: FontWeight.w700,
...
TextStyle alt_h3 = GoogleFonts.poppins(
  textStyle: const TextStyle(
    color: secondaryColor,
    fontSize: 20,
    fontWeight: FontWeight.w600,
...
TextStyle alt_h4 = GoogleFonts.poppins(
  textStyle: const TextStyle(
    color: secondaryColor,
    fontSize: 16,
    fontWeight: FontWeight.w600,
